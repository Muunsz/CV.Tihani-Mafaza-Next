...
const menuItems = [
  { label: "Dashboard", href: "/customer/dashboard", icon: LayoutGrid, description: "Ringkasan akun Anda" },
  { label: "Katalog Produk", href: "/customer/products", icon: ShoppingBag, description: "Jelajahi produk" },
  { label: "Keranjang", href: "/customer/cart", icon: ShoppingBag, description: "Lihat keranjang belanja" },
  { 
    label: "Pesanan Saya", 
  ...
  { label: "Wishlist", href: "/customer/wishlist", icon: Heart, description: "Produk favorit Anda" },
  { label: "Notifikasi", href: "/customer/notifications", icon: Bell, description: "Pesan dan update" },
];

const profileMenuItems = [
  { label: "Profil", href: "/customer/profile", icon: User, description: "Informasi akun" },
  { label: "Alamat", href: "/customer/profile/addresses", icon: MapPin, description: "Kelola alamat" },
  { label: "Pembayaran", href: "/customer/profile/payments", icon: CreditCard, description: "Metode pembayaran" },
  { label: "Keamanan", href: "/customer/profile/change-password", icon: Settings, description: "Ubah password" },
];

const loyaltyStats = [
  { label: "Poin Reward", value: "2,450", icon: Award, color: "from-amber-400 to-orange-500" },
  { label: "Total Belanja", value: "Rp 12.5jt", icon: TrendingUp, color: "from-blue-400 to-blue-600" },
  { label: "Pesanan Aktif", value: "3", icon: Truck, color: "from-green-400 to-emerald-600" },
  { label: "Rating", value: "4.8★", icon: Star, color: "from-purple-400 to-pink-500" },
];
