...
const categories = ['Semua', 'Panduan', 'Bisnis', 'Industri', 'Logistik', 'Kualitas', 'Keuangan'];

export const metadata = {
  title: 'Blog & Artikel - CV. Tihani Mafaza',
  description: 'Baca artikel dan panduan tentang pengadaan barang, bisnis, dan industri',
};
        ...
        <section className="bg-gradient-to-b from-blue-50 to-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              Baca artikel dan panduan tentang pengadaan barang, bisnis, dan industri terkini.
            </p>
          </div>
        </section>
            ...
            <div className="flex flex-wrap gap-3">
              {categories.map((cat) => (
                <button
                  ...
                  style={{
                    backgroundColor: cat === 'Semua' ? COLORS.accent : undefined,
                  }}
                >
                  {cat}
                </button>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 mb-8">
              Dapatkan artikel dan tips terbaru langsung ke email Anda setiap minggu.
            </p>
