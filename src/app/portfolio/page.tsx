...
const projects = [
  ...
  },
  {
    ...
    description: 'Penyediaan lengkap alat dan bahan laboratorium standar internasional.',
  ...
  },
  {
    ...
    description: 'Suplai material berkualitas untuk proyek infrastruktur publik.',
...
export const metadata = {
  ...
  description: 'Lihat koleksi proyek-proyek sukses yang telah kami kerjakan untuk berbagai klien',
};
        ...
        <section className="bg-gradient-to-b from-blue-50 to-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              Kami bangga dengan setiap proyek yang telah kami tangani. Berikut adalah beberapa
              proyek terkemuka yang menunjukkan dedikasi kami terhadap keunggulan.
            </p>
          </div>
        </section>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs text-gray-500 font-semibold">{project.year}</span>
                    </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              Hubungi tim kami untuk mendiskusikan kebutuhan spesifik proyek Anda.
            </p>
            <a
              href="/contact"
