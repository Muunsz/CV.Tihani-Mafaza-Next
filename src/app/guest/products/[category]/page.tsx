        ...
        <section className="bg-linear-to-b from-blue-50 to-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              Jelajahi koleksi lengkap produk dalam kategori{" "}
              {category.name.toLowerCase()}. Total {products.length} produk
              tersedia.
            </p>
          </div>
        </section>
            ...
            {products.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-600 mb-6">
                  Kategori ini sedang dalam pengembangan. Silakan kembali ke
                  katalog.
                </p>
                <Link
                  href="/products"
