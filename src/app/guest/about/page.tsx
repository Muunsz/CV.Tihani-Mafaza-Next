...
export const metadata = {
  ...
  description:
    "Profil perusahaan CV. Tihani Mafaza - penyedia barang & jasa profesional sejak 15 tahun",
};
        ...
        <section className="bg-gradient-to-b from-blue-50 to-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              Dibangun atas kepercayaan dan dedikasi, kami melayani dengan
              sepenuh hati.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    CV. Tihani Mafaza adalah badan hukum yang bergerak di bidang
                    pengadaan barang dan layanan profesional. Dengan pengalaman
                    lebih dari 15 tahun melayani institusi pendidikan,
                    pemerintah, dan korporat di Bandung dan sekitarnya.
                  </p>
                  <p>
                    Kami berkomitmen untuk memberikan solusi terbaik dengan
                    transparansi harga, kualitas terjamin, dan layanan yang
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="bg-white p-8 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Menjadi mitra terpercaya nomor satu dalam pengadaan barang dan
                  jasa berkualitas di wilayah Bandung, dengan layanan yang
                  inovatif, transparan, dan selalu customer-centric.
                </p>
              </div>
              <div className="bg-white p-8 rounded-lg border border-gray-200">
                <h3
                ...
                <ul className="space-y-3">
                  <li className="flex gap-3">
                    ...
                    <span className="text-gray-700">
                      Menyediakan produk berkualitas dengan harga kompetitif dan
                      transparan
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    />
                    <span className="text-gray-700">
                      Memberikan layanan excellent yang melampaui ekspektasi
                      klien
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    />
                    <span className="text-gray-700">
                      Membangun kemitraan jangka panjang yang saling
                      menguntungkan
                    </span>
                  </li>
                </ul>
              ...
              {[
                {
                  ...
                  title: "Kepercayaan",
                  description:
                    "Integritas dan kejujuran dalam setiap transaksi",
                },
                {
                  icon: "⭐",
                  title: "Kualitas",
                ...
                },
                {
                  ...
                  title: "Inovasi",
                  description:
                    "Selalu mencari cara terbaik untuk melayani Anda",
                },
                {
                  icon: "💪",
                  title: "Dedikasi",
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <p className="mb-8 text-lg opacity-90">
              Hubungi kami hari ini untuk mendiskusikan kebutuhan pengadaan
              barang Anda.
            </p>
            <a
              href="/contact"
