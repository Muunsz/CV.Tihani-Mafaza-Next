      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: COLORS.primary }}>
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-gray-200">Profesional berpengalaman yang siap melayani Anda dengan sepenuh hati</p>
          </div>
        </section>
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Keluarga Besar Tihani Mafaza</h2>
            <p className="text-gray-600 text-lg leading-relaxed">
              Kami terdiri dari profesional muda yang berdedikasi tinggi dengan pengalaman bertahun-tahun di bidangnya masing-masing. 
              Setiap anggota tim kami membawa passion dan komitmen yang sama: memberikan yang terbaik untuk kepuasan klien kami.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {TEAM_MEMBERS.map((member) => (
                <Card key={member.id} className="overflow-hidden hover:shadow-lg transition">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: COLORS.primary }}>
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-12">Nilai-Nilai Inti Tim Kami</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="text-white">
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
                  <span className="text-2xl">🤝</span> Integritas
                </h3>
                <p className="text-gray-200">Kami berkomitmen untuk selalu jujur dan transparan dalam setiap transaksi bisnis dengan klien kami.</p>
              </div>
              <div className="text-white">
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
                  <span className="text-2xl">⚡</span> Profesionalisme
                </h3>
                <p className="text-gray-200">Setiap anggota tim kami mengedepankan profesionalisme tinggi dalam menjalankan tugas mereka.</p>
              </div>
              <div className="text-white">
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
                  <span className="text-2xl">💡</span> Inovasi
                </h3>
                <p className="text-gray-200">Kami terus berinovasi untuk memberikan solusi terbaik dan terdepan dalam industri.</p>
              </div>
              <div className="text-white">
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
                  <span className="text-2xl">❤️</span> Dedikasi
                </h3>
                <p className="text-gray-200">Kepuasan klien adalah prioritas utama kami, dan kami berkomitmen melayani 24/7.</p>
              </div>
            </div>
          </div>
        </section>
