      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            {[
              { id: 'ORD-001', customer: 'PT Maju Jaya', amount: 15000000, time: '2 jam lalu' },
              { id: 'ORD-002', customer: 'PT Berkah Sejahtera', amount: 8500000, time: '4 jam lalu' },
              { id: 'ORD-003', customer: 'CV Semangat Kerja', amount: 22000000, time: '6 jam lalu' },
              { id: 'ORD-004', customer: 'PT Maju Jaya', amount: 12000000, time: '1 hari lalu' },
            ].map((order) => (
              <div key={order.id} className="border-b pb-3 last:border-0">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-sm">Rp{(order.amount / 1000000).toFixed(1)}M</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            <div className="flex gap-3 p-3 rounded-lg bg-yellow-50 border border-yellow-200">
              ...
              <div>
                <p className="font-semibold text-sm text-yellow-900">Stok Menipis</p>
                <p className="text-xs text-yellow-800">Kursi Kerja tinggal 5 unit</p>
              </div>
            </div>
            <div className="flex gap-3 p-3 rounded-lg bg-blue-50 border border-blue-200">
              <AlertCircle size={20} className="text-blue-600 flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-semibold text-sm text-blue-900">Backup Harian</p>
                <p className="text-xs text-blue-800">Backup selesai jam 03:00 AM</p>
              </div>
            </div>
            <div className="flex gap-3 p-3 rounded-lg bg-green-50 border border-green-200">
              ...
              <div>
                <p className="font-semibold text-sm text-green-900">Update Tersedia</p>
                <p className="text-xs text-green-800">Versi sistem 2.1.0 siap diupdate</p>
              </div>
            </div>
          </div>
        </div>
